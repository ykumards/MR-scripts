...
hadoop jar $HADOOP_HOME/lib/hadoop-mapreduce/hadoop-streaming.jar -D mapred.reduce.tasks=$redNo -file `pwd`/src -mapper src/mapper.sh -reducer src/reducer.sh -input book.txt -output spawn.out
